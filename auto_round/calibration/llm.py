...
class LLMCalibrator(Calibrator):
    ...
    def _cache_raw_input_ids_(self, input_ids) -> None:
        ...
        the last token of every sample (no next-token target). Shared by the
        standard and multimodal calib drivers - the predictor-tree stage and
        the valid-token-mask derivation consume the cached ids.
        """
