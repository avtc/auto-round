...
class SignRoundQuantizer(BaseQuantizer):
    ...
    def quantize_block(
        ...
        **kwargs,
        ...
        _tp["wrap"] = _ptime.perf_counter() - _t0
        _t0 = _ptime.perf_counter()  # prepare: engagement + params + optimizer
        ...
        try:
            ...
            if replica_group is not None:
                ...
                _t0 = _ptime.perf_counter()  # tail resumes after teardown
        ...
        _tp["tail"] = _ptime.perf_counter() - _t0
