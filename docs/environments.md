...
### AR_TUNE_DISABLE_P2P
- **Description**: When set, skips CUDA peer-access enablement; cross-device copies stage
  through host memory instead. Useful to A/B test the P2P benefit or to troubleshoot machines
